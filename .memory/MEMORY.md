...
- **필수 3대 태그 (상위 1~3번 고정)**: 원어민강사 / 원어민채용 / 원어민구인 (도미네이트 목표)
- **필수 태그**: 브릿지 / 원어민채용 / 원어민에이전시 / 브릿지에이전시 / 영어선생님고용
...
- **존댓말**: ~합니다/~입니다 통일 (반말 절대 금지)
- **제목 금지**: "완벽 정리", "총정리", "알아보겠습니다", "꼭 알아야 할"
- **광고 금지**: "브릿지가 책임집니다", "무료", "직원 수", "규모 직접 언급"
- **출력 형식**: 로직 내부 실행 + 완성본 1회만 출력 (중간 보고 금지)
- **v6.3.1 변경사항**: 확장 주제 6→9개 / 에이전시 섹션 150~200자→100자 이내 / STEP 9 모바일 줄바꿈 점검 신설 / 줄바꿈 15~17자→15~20자
