          ...
          <div style={{width:400,display:"flex",flexDirection:"column",background:"#f8f8f8",flexShrink:0}}>
            ...
            <div style={{flex:1,overflowY:"auto",padding:"14px"}}>
              <div style={{background:"#fff",borderRadius:6,boxShadow:"0 1px 4px rgba(0,0,0,0.05)"}}>
                ...
                <div style={{padding:"14px",fontSize:"0.88rem",lineHeight:1.7}} dangerouslySetInnerHTML={{__html:sanitizeHtml(previewHtml)}}/>
  ...
  if(loading)return(
    <div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"60vh",color:"#888"}}>
      <div style={{textAlign:"center"}}>
        ...
        <div style={{fontSize:"1rem",fontWeight:600}}>구인자 데이터 로딩 중...</div>
      </div>
    </div>
  );

  return(
    <div style={{display:"flex",flexDirection:"column",height:"100%",fontFamily:"'Malgun Gothic',-apple-system,sans-serif",background:"#f0f0f0",overflow:"hidden"}}>
      <style>{`
