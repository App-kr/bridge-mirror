  ...
  return (
    <div className="max-w-[860px] mx-auto px-4 sm:px-6 py-12 text-[#1d1d1f]">
      ...
      <div className="space-y-10 text-sm text-gray-700 leading-7">
        ...
        <Article num="제4조" title="알선의 기준">
          <ol className="list-decimal pl-5 space-y-2">
            <li>소개서비스는 무료가 아니며, 알선요금은 인력 관리 비용이 아니라 적합한 인력을 <strong>알선한 행위</strong>에 대한 대가입니다.</li>
            <li>근무 당일이라도 계약 해지(해고) 권리는 구인기관에 있으나, 이미 근무가 이루어진 일자에 대한 소개요금은 지급 대상입니다.</li>
            <li>인력이 현장에 배치되어 미팅 등 업무를 시작한 순간부터 알선 서비스의 효력이 발생하며, 이에 따른 수수료 지불 의무가 생깁니다.</li>
            <li>해고 없이 동일 인력을 계속 사용하면서 대체 인력이나 환불을 별도로 요청하며 서비스 기간을 넘기는 경우는 지원 대상에서 제외됩니다.</li>
          </ol>
        </Article>
