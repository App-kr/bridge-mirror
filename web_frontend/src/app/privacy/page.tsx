  ...
  return (
    <div className="max-w-[680px] mx-auto px-4 sm:px-6 py-14 text-[#1d1d1f] text-sm leading-7">
      ...
      <Section title="수집하는 개인정보 항목 및 수집 방법">
        ...
        <p className="mt-2">구직자: 성명, 생년월일, 성별, 국적, 현재 거주국, 여권정보, 이메일 주소, 전화번호, 카카오톡 ID, 학력사항, 경력사항, 자격증, 비자정보, 범죄경력조회 결과, 사진, 이력서 및 자기소개서, 기타 채용에 필요한 개인정보</p>
        <p className="mt-2">구인자: 학교·기관의 경우 담당자 성명, 연락처, 사업자등록번호, 계약정보, 채용 요건 등 채용에 필요한 정보</p>
      </Section>
