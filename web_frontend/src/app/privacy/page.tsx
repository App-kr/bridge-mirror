  ...
  return (
    <div className="max-w-[860px] mx-auto px-4 sm:px-6 py-12 text-[#1d1d1f]">
      ...
      <div className="mb-10">
        ...
        <p className="text-sm text-gray-400">6월, 2021. BRIDGE</p>
      </div>
      ...
      <div className="space-y-10 text-sm text-gray-700 leading-7">
        ...
        <Article num="제2조" title="개인정보의 처리 목적">
          ...
          <SubItem title="고충처리 및 분쟁 대응">
            계약 이행에 대한 보존, 분쟁조정 등 필요업무에 대한 기록 보존을 목적으로 합니다.
          </SubItem>
        </Article>
        ...
        <Article num="제4조" title="정보주체의 권리·의무 및 행사 방법">
          <p>이용자는 언제든지 개인정보의 열람·정정·삭제·처리정지를 요청할 수 있습니다. 서면 또는 이메일로 요청 시, 당사는 관계 법령(상법, 전자상거래법 등)에 따라 보존 의무가 있는 경우 또는 법적 분쟁이 예상되는 경우를 제외하고는, 요청일로부터 30일 이내에 해당 정보를 삭제합니다. 보존이 필요한 정보는 별도의 DB로 분리하여 안전하게 보관하며, 보존 기간이 경과하면 즉시 파기합니다.</p>
        </Article>

        <Article num="제5조" title="개인정보의 제3자 제공">
          <p>채용이 확정되는 경우, 근로계약 체결에 필요한 범위 내에서 해당 구인 학교·기관에 관련 정보를 제공하며, 근로자가 알아야 할 필수 정보는 구직자에게도 공유합니다. 법령에 따른 요청이 있는 경우는 예외로 하며, 그 외에는 동의 없이 제3자에게 제공하지 않습니다.</p>
        </Article>
